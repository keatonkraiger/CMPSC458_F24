...
int main(int argc, char **argv)
{
	...
	// ------------------------------------
	Shader ourShader("../OpenGL_tutorial_II/Shaders/shader.vert", "../OpenGL_tutorial_II/Shaders/shader.frag");
	...
	unsigned char *data = stbi_load("../OpenGL_tutorial_II/Media/textures/container.jpg", &width, &height, &nrChannels, 0);
	if (data)
	{
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	// load image, create texture and generate mipmaps
	data = stbi_load("../OpenGL_tutorial_II/Media/textures/awesomeface.png", &width, &height, &nrChannels, 0);
	if (data)
	{
